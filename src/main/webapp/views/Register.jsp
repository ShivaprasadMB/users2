...
<html lang="en">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="number" class="form-control" name="mobile" id="inputEmail3">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
		  <label for="btns" class="col-sm-2 col-form-label"></label>
      <button  class="btn btn-primary btn-lg btn-block" id="btns" type="submit" class="btn btn-primary">Submit</button>
    </div>
  </div>
</form>
  </div>
